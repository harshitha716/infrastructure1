# module "banking_eu" {
#   source                = "../../../modules/services-eu/banking"
#   region                = var.region_eu
#   project_id            = var.project_id
#   project_prefix        = local.project_prefix_eu
#   spanner_instance_name = var.spanner_instance_name_eu
...
#   pubsub_topics         = local.pubsub_topics_eu
#   buckets = [{
#     name       = "analytics-dataflow"
#     log_bucket = "${local.project_prefix_eu}-gcs-logging"
#     },
#     {
#       name       = "analytics"
#       log_bucket = "${local.project_prefix_eu}-gcs-logging"
